...
watering_wait == 259200 #it waits 3 days after watering before asking for signal again
check_wait == 7200 #checks for arduino signal every 2 hours
pump_on == 5 #turns on the pump for this long
